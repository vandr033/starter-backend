...
SET @col_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    ...
    AND COLUMN_NAME = 'auto_confirm_bookings'
);
SET @sql := IF(
  @col_exists = 0,
...
SET @col_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'company_settings'
    AND COLUMN_NAME = 'require_comprobante_for_qr'
);
SET @sql := IF(
  @col_exists = 0,
...
SET @col_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    ...
    AND COLUMN_NAME = 'announcement_banners'
);
SET @sql := IF(
  @col_exists = 0,
...
SET @col_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'theme_config'
    AND COLUMN_NAME = 'home_section_order'
);
SET @sql := IF(
  @col_exists = 0,
...
SET @idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    ...
    AND INDEX_NAME = 'review_company_id_fkey'
);
SET @sql := IF(
  @idx_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_reservation_deposit'
    AND CONSTRAINT_NAME = 'restaurant_reservation_deposit_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_reservation_deposit'
    AND CONSTRAINT_NAME = 'restaurant_reservation_deposit_reservation_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_reservation_deposit'
    AND CONSTRAINT_NAME = 'restaurant_reservation_deposit_submitted_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_reservation_deposit'
    AND CONSTRAINT_NAME = 'restaurant_reservation_deposit_reviewed_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_reservation_deposit'
    AND CONSTRAINT_NAME = 'restaurant_reservation_deposit_refunded_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_shift_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_closed_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_reopened_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout_adjustment'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_adjustment_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout_adjustment'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_adjustment_closeout_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_closeout_adjustment'
    AND CONSTRAINT_NAME = 'restaurant_shift_closeout_adjustment_actor_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift'
    AND CONSTRAINT_NAME = 'restaurant_shift_shift_manager_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_dining_area'
    AND CONSTRAINT_NAME = 'restaurant_shift_dining_area_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_dining_area'
    AND CONSTRAINT_NAME = 'restaurant_shift_dining_area_shift_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_dining_area'
    AND CONSTRAINT_NAME = 'restaurant_shift_dining_area_dining_area_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_template_dining_area'
    AND CONSTRAINT_NAME = 'restaurant_shift_template_dining_area_template_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_template_dining_area'
    AND CONSTRAINT_NAME = 'restaurant_shift_template_dining_area_dining_area_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_template_table_assignment'
    AND CONSTRAINT_NAME = 'restaurant_shift_template_table_assignment_template_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_template_table_assignment'
    AND CONSTRAINT_NAME = 'restaurant_shift_template_table_assignment_table_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_shift_template_table_assignment'
    AND CONSTRAINT_NAME = 'restaurant_shift_template_table_assignment_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_operational_state'
    AND CONSTRAINT_NAME = 'restaurant_table_operational_state_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_operational_state'
    AND CONSTRAINT_NAME = 'restaurant_table_operational_state_table_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_operational_state'
    AND CONSTRAINT_NAME = 'restaurant_table_operational_state_updated_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_combination_session'
    AND CONSTRAINT_NAME = 'restaurant_table_combination_session_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_combination_session'
    AND CONSTRAINT_NAME = 'restaurant_table_combination_session_combination_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_combination_session'
    AND CONSTRAINT_NAME = 'restaurant_table_combination_session_reservation_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_combination_session'
    AND CONSTRAINT_NAME = 'restaurant_table_combination_session_created_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_combination_session'
    AND CONSTRAINT_NAME = 'restaurant_table_combination_session_released_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_reservation_assignment'
    AND CONSTRAINT_NAME = 'restaurant_reservation_assignment_assigned_by_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_audit_log'
    AND CONSTRAINT_NAME = 'restaurant_audit_log_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_audit_log'
    AND CONSTRAINT_NAME = 'restaurant_audit_log_actor_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_audit_log'
    AND CONSTRAINT_NAME = 'restaurant_audit_log_shift_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_audit_log'
    AND CONSTRAINT_NAME = 'restaurant_audit_log_table_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_audit_log'
    AND CONSTRAINT_NAME = 'restaurant_audit_log_reservation_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_audit_log'
    AND CONSTRAINT_NAME = 'restaurant_audit_log_combination_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'commerce_order_item_component_snapshot'
    AND CONSTRAINT_NAME = 'commerce_order_item_component_snapshot_component_product_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'group_class_enrollment'
    AND CONSTRAINT_NAME = 'group_class_enrollment_sponsored_by_group_class_session_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'group_class_enrollment'
    AND CONSTRAINT_NAME = 'group_class_enrollment_sponsored_by_admin_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'group_class_guest_enrollment_session'
    AND CONSTRAINT_NAME = 'group_class_guest_enrollment_session_group_class_session_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'group_session_public_attendance_attempt'
    AND CONSTRAINT_NAME = 'group_session_public_attendance_attempt_company_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'group_session_public_attendance_attempt'
    AND CONSTRAINT_NAME = 'group_session_public_attendance_attempt_group_class_session_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @fk_exists := (
  ...
  WHERE CONSTRAINT_SCHEMA = DATABASE()
    AND TABLE_NAME = 'group_session_public_attendance_attempt'
    AND CONSTRAINT_NAME = 'group_session_public_attendance_attempt_resolved_user_id_fkey'
);
SET @sql := IF(
  @fk_exists = 0,
...
SET @old_idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    ...
    AND INDEX_NAME = 'free_event_registration_company_event_idx'
);
SET @new_idx_exists := (
  SELECT COUNT(*)
  FROM information_schema.STATISTICS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'free_event_registration'
    AND INDEX_NAME = 'free_event_registration_company_id_group_event_id_idx'
);
SET @sql := IF(
  @old_idx_exists > 0 AND @new_idx_exists = 0,
...
SET @old_idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'free_event_registration'
    AND INDEX_NAME = 'free_event_registration_event_email_key'
);
SET @new_idx_exists := (
  SELECT COUNT(*)
  FROM information_schema.STATISTICS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'free_event_registration'
    AND INDEX_NAME = 'free_event_registration_group_event_id_email_key'
);
SET @sql := IF(
  @old_idx_exists > 0 AND @new_idx_exists = 0,
...
SET @new_idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'free_event_registration'
    AND INDEX_NAME = 'free_event_registration_group_event_id_reservation_code_idx'
);
SET @sql := IF(
  @old_idx_exists > 0 AND @new_idx_exists = 0,
...
SET @old_idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'free_event_registration'
    AND INDEX_NAME = 'free_event_registration_event_status_idx'
);
SET @new_idx_exists := (
  SELECT COUNT(*)
  FROM information_schema.STATISTICS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'free_event_registration'
    AND INDEX_NAME = 'free_event_registration_group_event_id_status_idx'
);
SET @sql := IF(
  @old_idx_exists > 0 AND @new_idx_exists = 0,
...
SET @old_idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_operational_state'
    AND INDEX_NAME = 'restaurant_table_state_table_id_key'
);
SET @new_idx_exists := (
  SELECT COUNT(*)
  FROM information_schema.STATISTICS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'restaurant_table_operational_state'
    AND INDEX_NAME = 'restaurant_table_operational_state_table_id_key'
);
SET @sql := IF(
  @old_idx_exists > 0 AND @new_idx_exists = 0,
...
SET @old_idx_exists := (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'user'
    AND INDEX_NAME = 'User_phoneNumber_key'
);
SET @new_idx_exists := (
  SELECT COUNT(*)
  FROM information_schema.STATISTICS
